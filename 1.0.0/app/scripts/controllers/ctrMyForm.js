    ...
    $scope.sendHtml = function(cid,data){
        ...
        if(data.OrderList.length==0){      //判断是否有记录
            ...
            for(var i=0;i<data.OrderList.length;i++){
                ...
                "<td><p class='ha20'><a href='#/viewDetails/"+data.OrderList[i][0][0]+"'>详情</a></p><p class='ha20'><a data-toggle='modal' data-ng-click='deleGoods("+delteNum+","+dealStatus+")'>删除</a></p></td></tr>";
